...
def recipe_spider(urls):
    ...
    except (requests.exceptions.TooManyRedirects,requests.exceptions.MissingSchema,KeyError) as e:
        print "Error"

#link_spider('http://www.foodnetwork.com/recipes/a-z')
#recipe_spider('http://www.foodnetwork.com/grilling/grilling-central-burgers-and-hot-dogs')
